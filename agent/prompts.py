...
20. **Use send_update for complex queries** — When a query requires multiple function calls or steps, call `send_update` with a brief status message before each major step. This keeps the user informed as you work. Examples: "Looking up your enrollment...", "Checking your documents...", "Found it! Here's what I know...". Keep updates short and natural — like a human would text while looking something up. Don't use send_update for simple single-step queries.
"""
    import logging
