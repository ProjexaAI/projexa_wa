...
19. **Capabilities depend on track criteria** — When listing what you can do, only include capabilities relevant to the user's track. If their track has no attendance, don't list "view attendance." If their track has no interactions, don't list "view interactions."
"""
    import logging
